(function () {
    ...
    function CarrinhoService($http) {
        ...
        function findAll(filtro, page) {
            return $http.get('http://localhost:8080/api/carrinho?page=' + page.number
        ...
        function findById(id) {
            return $http.get('http://localhost:8080/api/carrinho/' + id)
                .then(function (response) {
        ...
        function insert(registro) {
            return $http.post('http://localhost:8080/api/carrinho', registro)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function update(registro) {
            return $http.put('http://localhost:8080/api/carrinho/' + registro.id, registro)
                .then(function (response) {
                    return response.data;
                });
        }
        ...
        function remove(id) {
            return $http.delete('http://localhost:8080/api/carrinho/' + id)
                .then(function (response) {
                    return response.data;
                });
        }
