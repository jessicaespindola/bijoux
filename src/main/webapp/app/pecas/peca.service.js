(function(){
  ...
  angular.module('app')
    ...
    PecaService.$inject = ['$http'];

    function PecaService($http) {
    
    
    function findAllOver() {
            return $http.get('http://localhost:8080/api/pecas/all?order=descricao')
        ...
        return $http.get('http://localhost:8080/api/pecas?page=' + page.number 
  ...
  function findById(id) {
      return $http.get('http://localhost:8080/api/pecas/' + id)
        .then(function (response) {
            return response.data;
        });
  }
  ...
  function insert(registro) {
      return $http.post('http://localhost:8080/api/pecas', registro)
        .then(function (response) {
            return response.data;
        });
  }
  ...
  function update(registro) {
      return $http.put('http://localhost:8080/api/pecas/' + registro.id, registro)
        .then(function (response) {
            return response.data;
        });
  }
  ...
  function remove(id) {
      return $http.delete('http://localhost:8080/api/pecas/' + id)
        .then(function (response) {
            return response.data;
        });
  }
